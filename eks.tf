...
resource "aws_iam_role" "alb_controller_role" {
  name = "AmazonEKSLoadBalancerController-${var.purpose}-Role"
...
resource "aws_iam_policy" "alb_controller_policy" {
  name = "AWSLoadBalancerControllerIAM-${var.purpose}-Policy"
...
resource "aws_iam_role_policy_attachment" "aws_iam_role_policy_attachment_alb_controller_policy" {
